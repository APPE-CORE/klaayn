...
export default function Footer() {
  ...
  return (
    /* MISE À JOUR : Fond de section en var(--color-void) */
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col gap-4">
        ...
        */}
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* --- BLOC 1 : VISION --- */}
          {/* MISE À JOUR : Fond du Bento en var(--color-contrast) */}
          <div className="flex flex-col justify-center p-8 md:p-10 bg-[var(--color-contrast)] border border-[var(--color-border)] rounded-[2rem] min-h-[240px]">
            <h2 className="text-display text-3xl md:text-5xl font-bold tracking-tight text-[var(--color-txt-main)] leading-[1] mb-4">
              Votre <br />
              <span className="text-[var(--color-txt-dim)]">Vision.</span>
            </h2>
            <p className="text-body text-[var(--color-txt-muted)] text-sm md:text-base max-w-sm leading-relaxed">
          ...
          <Link 
            href="/contact" 
            className="group relative flex flex-row items-center justify-between p-8 md:p-10 bg-[var(--color-contrast)] border border-[var(--color-border)] rounded-[2rem] min-h-[240px] transition-all duration-500 
            hover:bg-[var(--color-action)] active:bg-[var(--color-action)] overflow-hidden"
          >
             <div className="relative z-10 flex flex-col justify-center h-full">
                ...
                <h2 className="text-display text-3xl md:text-5xl font-bold tracking-tight text-[var(--color-txt-main)] group-hover:text-black group-active:text-black transition-colors duration-500 leading-[1]">
                    Notre <br/> Impact.
                </h2>
             </div>
             ...
             <div className="relative z-10">
                <ArrowRight 
                    size={40} 
                    className="text-[var(--color-txt-main)] group-hover:text-black group-active:text-black transition-transform duration-500 group-hover:-rotate-45 group-active:-rotate-45" 
                />
             </div>
          </Link>
        ...
        */}
        {/* MISE À JOUR : Fond du Bento en var(--color-contrast) */}
        <div className="w-full bg-[var(--color-contrast)] border border-[var(--color-border)] rounded-[2rem] p-8 md:p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-8 pb-10">
                ...
                <div className="md:col-span-4 flex flex-col justify-between h-full">
                    <div>
                        ...
                        <span className="text-2xl font-[family-name:var(--font-outfit)] font-bold tracking-tighter text-[var(--color-txt-main)]">KLAAYN.</span>
                        </Link>
                ...
                <div className="md:col-span-3 flex flex-col justify-start">
                    ...
                    <ul className="space-y-3">
                        ...
                        <li key={link.name}>
                            ...
                            >
                            <span className="w-0 overflow-hidden group-hover:w-3 group-active:w-3 transition-all duration-300 text-[var(--color-action)] opacity-0 group-hover:opacity-100 group-active:opacity-100 font-[family-name:var(--font-jetbrains)] text-xs flex items-center">
                                —
                            </span>
                            {link.name}
                            </Link>
            ...
            <div className="flex flex-col-reverse md:flex-row justify-between items-center pt-8 border-t border-[var(--color-border)] text-[10px] text-[var(--color-txt-dim)] font-[family-name:var(--font-jetbrains)]">
